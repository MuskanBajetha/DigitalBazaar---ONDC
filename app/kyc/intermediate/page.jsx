...
export default function IntermediateKYCPage() {
  const router = useRouter()

  const handleNext = (e) => {
    e.preventDefault()
    // Redirect to the photo upload page without backend call
  ...
  return (
    <div className="min-h-screen bg-blue-50 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="bg-white/20 backdrop-blur-lg rounded-3xl p-8 w-[500px] relative z-10">
        ...
        <div className="mb-6">
          <h2 className="text-lg font-semibold">Step 2/4</h2>
          <h3 className="text-md font-semibold">Intermediate Verification</h3>
        ...
        <form onSubmit={handleNext} className="space-y-4">
          ...
          <div className="space-y-2">
            <Button className="w-full bg-white/90 border-none">
              ID Card
            </Button>
            <Button className="w-full bg-white/90 border-none">
              Driving License
